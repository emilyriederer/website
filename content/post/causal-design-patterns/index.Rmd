...
Similarly, statistics has many prototypical analyses; however, these frameworks are often siloed specific disciplines and clouded by domain-specific language that makes them hard to discover and masks their general applicability^[Two other examples of this are categorical data analysis methods associated only with text mining and time-to-event analyses covered predominately in survival analysis]. This can make it hard for practitioners outside of these fields to easily survey, learn, and apply these methods.
