...
1. (Optionally) Convert large, static files to Parquet versus CSV: DuckDB handles both well, but Parquet has additional benefits including compression (for easier storage and sharing), additional metadata, columnar storage, and (when partitioned) the ability to optimize retrieval with pruning
