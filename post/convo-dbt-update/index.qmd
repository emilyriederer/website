...
description: "Following up on 'Embedding Column-Name Contracts... with dbt' to demo my new dbtplyr package to further streamline the process"
author: "Emily Riederer"
date: "2021-09-21"
categories: [rstats, dbt]
image: "featured.PNG"
---

![Diff of original dbt model using dbtplyr's concise, declarative macros](featured.PNG)

Earlier this year, I wrote about [embedding column-name contracts in data pipelines with dbt](/post/convo-dbt/). This, in turn, built off my post regarding the general theory of [using controlled vocabularies to define data models](/post/column-name-contracts/).
