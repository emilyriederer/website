...
::: {.callout-warning}
Some advice in this post has gone stale regarding IDEs, installers, and environment management tools. Please see me [2025 update](post/py-rgo-2025) for more recent thoughts following the release of `uv` and `Positron`
:::
